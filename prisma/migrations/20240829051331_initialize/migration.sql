/*
  ...
  - Added the required column `measurementDate` to the `measure` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_measure" ("createdAt", "customerId", "hasConfirmed", "id", "imageUrl", "measureTypeId", "updatedAt") SELECT "createdAt", "customerId", "hasConfirmed", "id", "imageUrl", "measureTypeId", "updatedAt" FROM "measure";
DROP TABLE "measure";
